...
public class ConversationHubAuthorizationTests
{
    ...
    {
        var fixture = CreateHub(userIdClaim: "42");
        fixture.Conversations
            .Setup(r => r.GetConversationById(10, 42))
    ...
    [Fact]
    public async Task JoinConversation_JoinsGroup_WhenNumericActorIsActiveParticipant()
    {
        var fixture = CreateHub(userIdClaim: "42");
        fixture.Conversations
            .Setup(r => r.GetConversationById(10, 42))
    ...
    [Fact]
    public async Task OnConnected_ResolvesEmailIdentityToNumericUserGroup()
    {
        var fixture = CreateHub(userIdClaim: "person@example.com");
    ...
    private static HubFixture CreateHub(string userIdClaim)
    {
