...
test('declares focused receipt permissions in iOS and Expo image-picker config', async () => {
  ...
  assert.equal(iosInfo.NSCameraUsageDescription, 'Take photos or videos to document maintenance, property inspections, repair completion, or expense receipts.');
  assert.equal(iosInfo.NSPhotoLibraryUsageDescription, 'Choose photos or videos to document maintenance, property inspections, repair completion, or expense receipts.');

  assert.equal(imagePickerConfig.cameraPermission, 'Take photos or videos to document maintenance, property inspections, repair completion, or expense receipts.');
  assert.equal(imagePickerConfig.photosPermission, 'Choose photos or videos to document maintenance, property inspections, repair completion, or expense receipts.');
});
