...
namespace brownstone_hub_api.Repositories.Expenses
{
    public interface IExpenseRepository
    {
        ...
        Task<LoadExpenseDto> UpdateExpense(UpdateExpenseDto expense);
        Task<bool> DeleteExpense(long expenseId);
        Task<LoadExpenseDto?> GetExpenseById(long expenseId);
        ...
        Task<List<LoadExpenseDto>> GetExpensesByOrganizationId(long organizationId, long? propertyId = null, DateTime? startDate = null, DateTime? endDate = null, string? category = null, long? vendorId = null);
        ...
        Task<bool> MarkBillAsPaid(long expenseId, DateTime paidDate);
    }
}
