-- Script to seed HOA template and expenses for Property ID 95 and Units 160, 161, 162
-- This script creates:
-- 1. A RecurringExpense template for HOA payments (monthly, property-level)
-- 2. HOA Expense records for the property (not per unit)
-- 3. Random expenses for each unit (160, 161, 162)
