...
namespace brownstone_hub_api.Services.OrganizationService
{
    public interface IOrganizationService
    {
        ...
        Task<ServiceResponse<LoadOrganizationDto>> GetOrganizationByIdAsync(long organizationId, long selectedOrganizationId, long userId);
        ...
        Task<ServiceResponse<bool>> DeleteOrganizationAsync(long organizationId, long selectedOrganizationId, long userId);
