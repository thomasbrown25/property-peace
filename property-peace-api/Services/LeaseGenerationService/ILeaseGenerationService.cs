...
namespace brownstone_hub_api.Services.LeaseGenerationService
{
    public interface ILeaseGenerationService
    {
        ...
        Task<ServiceResponse<LoadLeaseInstanceDto>> CreateLeaseInstanceAsync(CreateLeaseInstanceDto dto, long organizationId);
        ...
        Task<ServiceResponse<LoadLeaseInstanceDto>> PrepareLeaseInstanceForFinalizationAsync(long instanceId, long organizationId);
        Task<ServiceResponse<LoadLeaseInstanceDto>> FinalizeLeaseInstanceAsync(long instanceId, long organizationId);
        Task<ServiceResponse<LoadLeaseInstanceDto>> ResolvePlaceholdersAsync(long instanceId, long organizationId);
        Task<ServiceResponse<List<string>>> ValidatePlaceholdersAsync(long instanceId, long organizationId);
        Task<ServiceResponse<LoadLeaseInstanceDto>> GetLeaseInstanceByIdAsync(long id, long organizationId);
        Task<ServiceResponse<List<LoadLeaseInstanceDto>>> GetLeaseInstancesByLeaseIdAsync(long leaseId, long organizationId);
        ...
        Task<ServiceResponse<LoadLeaseInstanceDto>> FinishLeaseAgreementAsync(long leaseId, long organizationId);
        ...
        Task<ServiceResponse<LeaseReviewResultDto>> ReviewLeaseInstanceAsync(long instanceId, long organizationId);
    }
}
