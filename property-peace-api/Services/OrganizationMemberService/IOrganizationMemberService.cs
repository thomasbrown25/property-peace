...
namespace brownstone_hub_api.Services.OrganizationMemberService
{
    ...
    {
        Task<ServiceResponse<LoadOrganizationMemberDto>> AddMemberAsync(AddOrganizationMemberDto dto, long invitedByUserId);
        Task<ServiceResponse<LoadOrganizationMemberDto>> UpdateMemberAsync(UpdateOrganizationMemberDto dto, long userId);
