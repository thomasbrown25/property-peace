...
namespace brownstone_hub_api.Services.ExpenseService
{
    public interface IExpenseService
    {
        ...
        Task<ServiceResponse<List<LoadExpenseDto>>> GetExpenses(long organizationId, long? propertyId = null, DateTime? startDate = null, DateTime? endDate = null, string? category = null, long? unitId = null);
