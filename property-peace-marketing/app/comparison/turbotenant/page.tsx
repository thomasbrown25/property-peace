    ...
    <main className="min-h-screen bg-white">
      ...
      <section data-marketing-hero-theme="light" className="relative overflow-hidden bg-gradient-to-b from-white to-[#F7FAFC] px-4 pb-20 pt-32 text-[#061E35] sm:px-6 md:pb-24 md:pt-36 lg:px-8">
        ...
        <div className="relative mx-auto max-w-6xl">
          <Link href="/" className="mb-8 inline-flex min-h-11 items-center gap-2 text-sm font-bold text-[#16A34A] transition hover:text-[#061E35]"><FiArrowLeft className="h-4 w-4" /> Back to Property Peace</Link>
          <div className="grid gap-10 lg:grid-cols-[1.12fr_0.88fr] lg:items-end">
            <div>
              <div className="mb-5 inline-flex items-center gap-2 border border-[#DCE6ED] bg-white px-4 py-2 text-xs font-bold uppercase tracking-[0.2em] text-[#16A34A]"><FiInfo className="h-4 w-4" /> Information checked {checkedOn}</div>
            ...
            <div className="border border-[#DCE6ED] bg-white p-6 shadow-[0_24px_60px_rgba(6,30,53,0.10)] md:p-8">
              <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#16A34A]">Our comparison standard</p>
