...
export const metadata: Metadata = applyOttoSeo('/features/', {
  ...
  description: "Explore Property Peace features for small landlords: rent collection, maintenance, leases, accounting, documents, messaging, and Percy-powered tools for 1–50 units.",
  ...
  openGraph: {
    title: "Property Management Software Features | Property Peace",
    description: "Rent collection, maintenance, leases, accounting, documents, messaging, and Percy-powered tools for small landlords with 1–50 units.",
    type: "website",
    url: "/features",
  },
});
...
const featureCategories = [
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'Get paid faster with automated rent reminders and seamless online payments. Tenants pay by card or bank transfer; you get a single view of everything.'
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'Never miss a due date or request. In-app, email, and SMS notifications the way you and your tenants want—so everyone stays in the loop.'
      },
      {
    ...
    features: [
      {
        ...
        description: 'Screen tenants without the paperwork. From invite to signed lease, all online—secure invites, one-click applications, and PDFs generated automatically.'
      },
      {
        slug: 'lease-management',
        icon: FiFile,
        title: 'Digital Lease Signing',
        description: 'Sign leases from anywhere. Paperless, legally binding e-signatures with DocuSign, plus automatic reminders so renewals never slip through.'
      }
    ]
  },
  {
...
export default function FeaturesPage() {
  ...
  const softwareSchema = {
    ...
    description: "Property management software features for independent landlords: rent, maintenance, leases, accounting, documents, messaging, and Percy-powered tools.",
          ...
          <div className="relative mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <p
                ...
                style={{ fontFamily: '"Inter", sans-serif' }}
              >
                Explore the practical tools inside Property Peace: rent collection, maintenance tracking, lease workflows, accounting, documents, tenant messaging, and Percy-powered features built for portfolios with 1–50 units.
              </p>
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-[2rem] bg-[#061e35] p-5 shadow-2xl shadow-slate-950/20">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {[
                    ['Rent collected', '$8,420', '3 payments auto-matched'],
