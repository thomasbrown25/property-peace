...
const categoryDetails: Record<string, { eyebrow: string; description: string }> = {
  ...
  Intelligence: {
    ...
    description: 'Use limited Percy Pilot briefings for supported records, rent comps, and a single dashboard to review what needs attention.',
  },
};
    ...
    features: [
      {
        ...
        description: 'In the limited Percy Pilot, Property Peace’s AI property assistant Percy provides landlord-opened, read-only briefings across supported rent-payment, maintenance, lease, and urgent in-app conversation records.'
      },
      {
        slug: 'rent-estimate',
        icon: FiTrendingUp,
          ...
          <div className="relative mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <p
                ...
                style={{ fontFamily: '"Inter", sans-serif' }}
              >
                Property Peace is the structured system of record and workflows for self-managing landlords: rent tracking, maintenance, leases, accounting, documents, and tenant messaging. Percy is Property Peace&apos;s AI property assistant, with landlord-opened, read-only help for supported records in the limited Percy Pilot.
              </p>
              ...
              <div className="relative overflow-hidden rounded-[2rem] bg-[#061e35] p-5 shadow-2xl shadow-slate-950/20">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {[
                    ...
                    ['Open maintenance', '4', 'Review recorded priority signals'],
                ...
                <div className="mt-4 rounded-2xl bg-white p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-bold text-[#061e35]">Limited Percy Pilot briefing</p>
        ...
        <section className="bg-white px-4 pb-20 pt-6 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-5xl overflow-hidden rounded-[2rem] bg-[#061e35] p-8 text-center shadow-2xl shadow-slate-950/15 md:p-12">
            ...
            <p
              ...
              style={{ fontFamily: '"Inter", sans-serif' }}
            >
              Property Peace keeps rent, maintenance, leases, accounting, and documents connected; limited Percy Pilot briefings review supported records without changing them.
            </p>
