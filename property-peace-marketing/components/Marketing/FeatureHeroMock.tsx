...
const featureSteps: Record<string, MockStep[]> = {
  ...
  'lease-management': [
    ...
    {
      label: 'Sign separately',
      caption: 'Use your preferred external signing process; integrated e-signature is not currently available.',
      callout: 'External step',
      eyebrow: 'Signing roadmap',
      title: 'Complete outside Property Peace',
      icon: FiFileText,
      tone: 'purple',
      rows: [
        { label: 'Provider', value: 'Your choice', status: 'External', tone: 'blue' },
        { label: 'Completed file', value: 'Upload', status: 'Next step', tone: 'green' },
        { label: 'Integration', value: 'Roadmap', status: 'Unavailable', tone: 'gray' },
      ],
      note: 'Store the completed document after signatures are collected separately.',
    },
    {
  ...
  'payment-processing': [
    {
      ...
      caption: 'Log rent received outside Property Peace.',
      callout: 'Ready to record',
      eyebrow: 'Offline payment record',
      title: 'Add a rent payment',
      icon: FiCreditCard,
      tone: 'blue',
      rows: [
    ...
    {
      label: 'Save status',
      caption: 'Keep the ledger current after receiving rent elsewhere.',
      callout: 'Status selected',
      eyebrow: 'Manual ledger update',
      title: 'Mark payment recorded',
      icon: FiRefreshCw,
      tone: 'purple',
      rows: [
        { label: 'Status', value: 'Paid', status: 'Manual', tone: 'green' },
        { label: 'Reference', value: 'May rent', status: 'Added', tone: 'blue' },
        { label: 'Tenant', value: 'Nora P.', status: 'Matched', tone: 'gray' },
      ],
      note: 'You control the status based on payments received through your existing method.',
    },
    {
      label: 'Review ledger',
      caption: 'See recorded rent and remaining balances in one place.',
      callout: 'Record saved',
      eyebrow: 'Rent tracking',
      title: '$1,450 recorded',
      icon: FiCheck,
      tone: 'green',
      rows: [
        { label: 'Balance', value: '$0', status: 'Recorded', tone: 'green' },
        { label: 'History', value: 'May 1', status: 'Visible', tone: 'blue' },
        { label: 'Next due', value: 'Jun 1', status: 'Tracked', tone: 'green' },
      ],
      note: 'Use payment history and reminders without changing how tenants pay you.',
    },
  ],
