...
export default function Theme1(colors, mode) {
  ...
  let primaryColors = ['#E7F0FF', '#D2E4FF', '#A9CCFF', '#63A4FF', '#2F85F5', '#1877F2', '#1464CC', '#0F52AA', '#0B3D7A', '#062B55'];
  ...
  if (mode === ThemeMode.DARK) {
    primaryColors = ['#E7F0FF', '#D2E4FF', '#A9CCFF', '#63A4FF', '#2F85F5', '#1877F2', '#1464CC', '#0F52AA', '#0B3D7A', '#062B55'];
