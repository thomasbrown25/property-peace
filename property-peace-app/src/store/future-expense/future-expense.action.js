import {
  getFutureExpenses,
  getFutureExpenseById,
  addFutureExpense,
  deleteFutureExpense
} from 'api/futureExpense';
import { FUTURE_EXPENSE_ACTION_TYPES } from './future-expense.types';

export const getFutureExpensesAction = (landlordId, filters = {}) => async (dispatch) => {
  try {
    dispatch({ type: FUTURE_EXPENSE_ACTION_TYPES.GET_FUTURE_EXPENSES_START });
