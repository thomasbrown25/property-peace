...
export default function Dashboard() {
  ...
  const showSetupCard = setupState.isLoading || !setupState.isComplete;
    ...
    <>
      ...
      >
        ...
        <MenuItem
          onClick={() => {
            handleCreateMenuClose();
            navigate('/landlord/finances?tab=expenses');
          }}
          sx={{ py: 1.25, px: 2 }}
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
        ...
        <MenuItem
          onClick={() => {
            handleCreateMenuClose();
            navigate('/landlord/leases?view=renewals');
          }}
          sx={{ py: 1.25, px: 2 }}
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
        ...
        <MenuItem
          onClick={() => {
            handleCreateMenuClose();
            navigate('/landlord/accounting/tax-center');
          }}
          sx={{ py: 1.25, px: 2 }}
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
