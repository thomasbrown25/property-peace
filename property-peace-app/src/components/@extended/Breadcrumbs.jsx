  ...
  if (main && main.type === 'collapse' && !main.breadcrumbs) {
    ...
    mainContent = (
      ...
      >
        ...
        {main?.title && <FormattedMessage id={main.title} />}
      </Typography>
    );
  ...
  if ((item && item.type === 'item') || (item?.type === 'group' && item?.url) || custom) {
    ...
    itemContent = (
      <Typography variant="subtitle1" color="text.primary">
        ...
        {itemTitle && <FormattedMessage id={itemTitle} />}
      </Typography>
    );
        ...
        >
          ...
          >
            {title && !titleBottom && (
              <Grid>
                <Typography variant="h2">
                  {((custom && heading) || (!custom && item?.title)) && <FormattedMessage id={custom ? heading : item?.title} />}
                </Typography>
              </Grid>
            )}
