...
const SEOHead = ({
  ...
  description = 'Best property management software for landlords. Streamline rent collection, tenant management, lease signing, and maintenance tracking. Start your free 30-day trial today!',
